...
public final class Entity {
	...
	public <T extends Component> void ifPresent(Class<T> clazz, Consumer<T> c) {
		T component = get(clazz);
		
		if(component != null) c.accept(component);
	}
	...
	public void beginContact(Contact contact, Entity other, Fixture fixture, Fixture otherFixture) {
		forAllComponents((c) -> c.beginContact(contact, other, fixture, otherFixture));
	}
	
	public void endContact(Contact contact, Entity other, Fixture fixture, Fixture otherFixture) {
		forAllComponents((c) -> c.endContact(contact, other, fixture, otherFixture));
	}
